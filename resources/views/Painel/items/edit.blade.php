...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edição de Items</li>
        </ol>
    </section>
            ...
            <div class="col-xs-6">
                ...
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ediçao de Items</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="{{ route('Painel.Items.update',['item' => $item->id]) }}" method="post">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" class="form-control  {{ $errors->has('nome') ? ' is-invalid' : '' }}"
                                    placeholder="Nome Completo" value="{{ old('nome') ?? $item->nome}}" name="nome" id="nome"
                                    autofocus required>
                            ...
                            <div class="form-group has-feedback ">
                                ...
                                <input type="text" class="form-control {{ $errors->has('descricao') ? ' is-invalid' : '' }}"
                                    placeholder="descricao" value="{{ old('descricao') ?? $item->descricao}}" name="descricao" id="descricao"
                                    autofocus required>
                                <span class="form-control-feedback"></span>
